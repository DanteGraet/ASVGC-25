return {
    data = {
        ...
        tracks = {  -- Starting Values
            ...
            [5] = {track = love.audio.newSource("music/theDam/secondHalfBackingV2.mp3","stream"),       volume = 0, targetVolume = 0},
            [6] = {track = love.audio.newSource("music/theDam/electricalMelody.mp3","stream"),  volume = 0, targetVolume = 0},
        },
    },
    zones = {
        ["Gravelly Plains"] =        {1,0,0,0,0,0},
        ["Upper Dam"] =              {0.8,0.8,0.6,1,0,0},
        ["The Inlet"] =              {0,0.7,0.7,0,1,0},
        ["_The Inlet"] =              {0,0.7,0.7,0,1,0},
        ["Electrical Complex"] =     {0,0,1,0,1,1},
