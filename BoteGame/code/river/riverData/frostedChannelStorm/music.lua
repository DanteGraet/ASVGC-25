...
return {
    data = {
        ...
        tracks = {  -- Starting Values
            ...
            [2] = {track = love.audio.newSource("music/mvpRiver/snowMelodyV2.mp3","stream"),        volume = 0.9, targetVolume = 0.9},
    ...
    zones = {
        ...
        ["Hailstone Heck"] =      stormValleyMusicManager,
        ["_Hailstone Heck"] =      {0.9,0,0,0,0,0},
