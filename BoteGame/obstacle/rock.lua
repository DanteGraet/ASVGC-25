...
local rockImages = {
    love.graphics.newImage("image/obstical/rock/1.png"),
    love.graphics.newImage("image/obstical/rock/2.png"),
    love.graphics.newImage("image/obstical/rock/3.png")
}
...
local rockObstical = setmetatable({}, Obstacle)
